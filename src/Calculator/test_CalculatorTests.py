...
class MyTestCase(unittest.TestCase):
    ...
    def test_addition_method(self):
        calculator = Calculator()
        test_cases = CsvReader("src/TestFiles/Unit Test Addition.csv").data
    ...
    def test_multiplication_method(self):
        calculator = Calculator()
        test_cases = CsvReader("src/TestFiles/Unit Test Multiplication.csv").data
        for test_case in test_cases:
    ...
    def test_subtraction_method(self):
        calculator = Calculator()
        test_cases = CsvReader("src/TestFiles/Unit Test Subtraction.csv").data
        for test_case in test_cases:
    ...
    def test_squaring_method(self):
        calculator = Calculator()
        test_cases = CsvReader("src/TestFiles/Unit Test Square.csv").data
        for test_case in test_cases:
    ...
    def test_square_root_method(self):
        calculator = Calculator()
        test_cases = CsvReader("src/TestFiles/Unit Test Square Root.csv").data
        for test_case in test_cases:
    ...
    def test_division_method(self):
        calculator = Calculator()
        test_cases = CsvReader("src/TestFiles/Unit Test Division.csv").data
        for test_case in test_cases:
